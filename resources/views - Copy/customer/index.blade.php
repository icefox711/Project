                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.{{number_format($wallet->saldo,0,',','.')}},00</div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Top Up Disini Dan Tarik Tunai
                                </div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                                    <div class="float-start">
                                        <button class="btn btn-primary btn-sm" data-target ="#topupModal"
                                            data-toggle="modal" type="button">Top Up</button>
                                        <button class="btn btn-primary btn-sm" data-target ="#tariktunaiModal"
